...
public class BufferChart extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3103927321172945158L;
	JFreeChart chart;
	JRadioButton both;
	JRadioButton max;
	...
	public BufferChart(int[] maxdata, double[] avgdata, String[] name) {
		chartTitle = "Buffer Size";
	...
	public CategoryDataset getDataset(String[] type, int[] max, double[] avg) {
