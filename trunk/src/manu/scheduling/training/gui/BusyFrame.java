 ...
 * @author Tao Zhang
 */
public class BusyFrame extends JFrame implements BusyComponentInterface {
	...
	public BusyFrame(String title) {
		...
		Runnable doHelloWorld = new Runnable() {
			public void run() {
				contentPanel.setBounds(0, 0, mainPanel.getWidth(),
						mainPanel.getHeight());
				busyPanel.setBounds(0, 0, mainPanel.getWidth(),
						mainPanel.getHeight());
			}
		};
		...
		this.addWindowStateListener(new WindowStateListener() {
			...
			public void windowStateChanged(WindowEvent arg0) {
				...
				contentPanel.setBounds(
						0,
						0,
						BusyFrame.this.getWidth()
								- BusyFrame.this.getInsets().left
								- BusyFrame.this.getInsets().right,
						BusyFrame.this.getHeight()
								- BusyFrame.this.getInsets().top
								- BusyFrame.this.getInsets().bottom
								- 22
								- (BusyFrame.this.getMenuBar() != null ? 22 : 0));

				busyPanel.setBounds(0, 0, mainPanel.getWidth(),
						mainPanel.getHeight());
				contentPanel.revalidate();
				busyPanel.revalidate();

			}
		});
	}

	private void setComponentEnable(Component component, boolean value,
			boolean onlyMouseListener) {
	...
	public void setWaitingTipFromOtherThreads(final String string) {
